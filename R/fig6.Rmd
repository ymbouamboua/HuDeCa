...
# Dominance bins
p <- plot_domscore(res$df, mode = "bins", ident.col = "ident", colors = colors, font.size = 10, leg.pos = "none")
p
...
p <- plot_domscore(res$df, mode = "high_cells", ident.col = "ident", stage.col = "stage", colors = colors, leg.dir = "vertical", leg.pos = c(0.2, 0.9))
p
...
p <- plot_domscore(res$df, mode = "top_genes", top.n = 20, flip = F, x.angle = 90)
p
