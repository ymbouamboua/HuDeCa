...
celldot(obj, features = canonical_markers, group.by = "ann2", flip = T,  x.angle = 90, font.size = 10) 
...
obj@meta.data[obj@meta.data$seurat_clusters %in% c(28),"ann2"] <- "MSC" 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(32),"ann2"] <-"Deut" # 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(7,41),"ann2"] <-"MCC" # 
...
obj@meta.data[obj@meta.data$seurat_clusters %in% c(19),"ann2"] <-"Peri" 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(22,40),"ann2"] <-"NP" 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(27),"ann2"] <-"GABA" 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(21,39),"ann2"] <-"GLUT" 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(38),"ann2"] <-"NOS1"
obj@meta.data[obj@meta.data$seurat_clusters %in% c(11),"ann2"] <- "OEC" 
obj@meta.data[obj@meta.data$subclusters %in% c("11_1"),"ann2"] <-"NCC" 
obj@meta.data[obj@meta.data$Braun_2023_majority_voting %in% c("Head neural crest cells"),"ann2"] <- "NCC" 
obj@meta.data[obj@meta.data$subclusters %in% c("11_4"),"ann2"] <-"SCP" 
obj@meta.data[obj@meta.data$subclusters %in% c("11_2"),"ann2"] <-"SC" 
...
obj@meta.data[obj@meta.data$seurat_clusters %in% c(9,18,29),"ann2"] <-"Cartl" 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(1,6,14),"ann2"] <-"Osteo" 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(4,37),"ann2"] <-"Mes0" 
...
obj@meta.data[obj@meta.data$seurat_clusters %in% c(42),"ann2"] <-"GBC" 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(8,16,31),"ann2"] <-"RHBC" 
#obj@meta.data[obj@meta.data$seurat_clusters %in% c(16),"ann2"] <-"0HBC"
obj@meta.data[rownames(obj@meta.data) %in% c(ohbc),"ann2"] <- "OHBC" 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(26),"ann2"] <-"CycBasal"
obj@meta.data[obj@meta.data$seurat_clusters %in% c(3),"ann2"]  <- "MV" 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(17),"ann2"]  <- "SUS" 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(25),"ann2"] <-"MG" 
obj@meta.data[obj@meta.data$seurat_clusters %in% c(23),"ann2"] <- "iOSN"
obj@meta.data[obj@meta.data$subclusters %in% c("23_1"),"ann2"] <- "INP" 
obj@meta.data[rownames(obj@meta.data) %in% c(gnrh1),"ann2"] <-"GnRH" 

cellmap(obj, group.by="ann2",  label = T, pt.size = 0.5)
